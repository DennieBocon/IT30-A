...
("WHAT ONCE WAS MINE","ELIZABETH J. BRASWELL","FANTASY"),
...
CREATE TABLE borrow(
    ...
    borrow_date_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Set borrow id for the borrowed you want to return
